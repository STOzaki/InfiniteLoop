...
public interface DAOAuthor extends DAOBasic{
	public List<Author> loadAuthors() throws IOException; //returns a list containing all authors in the dao
	public Author getAuthor(int id) throws IOException; //returns author with given id
